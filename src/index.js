...
//                   /pubembed in that URL. This is used for the
//                   embed redirect and consistently starts the
//                   presentation from slide 1 on every load.
//
...
export default {
  async fetch(request, env) {
    ...
    // consistently starts from slide 1 on every fresh load.

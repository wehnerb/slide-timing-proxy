...
//                   /pubembed in that URL. This format reliably
//                   starts the presentation from slide 1 when
...
export default {
  async fetch(request, env) {
    ...
    //
    // The URL is embedded in the visibility page rather than
    // used in a direct redirect. The display system pre-fetches
    // this Worker URL ~40 seconds before the slideshow slot
    // appears, so a direct redirect would cause Google Slides
    // to begin cycling in the background before it is visible.
    // The visibility page holds the URL idle until the Page
    // Visibility API confirms the screen is in the foreground,
    // at which point navigation fires and the presentation
...
// foreground. Navigation to the Google Slides pubembed URL only
// fires at that moment, guaranteeing the presentation always
// starts from slide 1 regardless of when the display system
// pre-fetched this page in the background.
// ============================================================
